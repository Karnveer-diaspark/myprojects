...
describe('CustomerDetailsComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [CustomerService, { provide: _, useValue: {} }, { provide: DialogService, useValue: data }, NotificationsService, MatSnackBar, MatToolbarModule, { provide: MAT_DIALOG_DATA, useValue: data }, { provide: MatDialogRef, entryComponents: ConfirmDialogComponent, useValue: dialogMock }],
  ...
  it('should execute ngOninit(), if there is value for formcid', () => {
    inject([data], (injectService: DialogService) => {
      expect(injectService).toBe(servicedialog);
    })
    component.formcid = data;
    component.isNumber = 47;
    expect(component.formcid).toEqual(data);
    expect(component.isNumber).toBe(47);
    const response: Customer[] = [];
    let app = component.service;
